...
//
// The only internet-facing service, with its own security zone and a per-principal
// authorization model rather than a per-tenant one.
...
openApiGenerate {
	...
	inputSpec = layout.projectDirectory.file("src/main/resources/openapi/orca-portal.yaml").asFile.path
	outputDir = layout.buildDirectory.dir("generated/openapi").get().asFile.path
	apiPackage = "com.lynxis.orca.portal.api.generated"
	modelPackage = "com.lynxis.orca.portal.api.generated.model"
...
val bundleOpenApiSpec = tasks.register<org.openapitools.generator.gradle.plugin.tasks.GenerateTask>("bundleOpenApiSpec") {
	...
	configOptions = mapOf("outputFile" to "static/openapi/orca-portal.yaml")
...
dependencies {
	...
	// served at /openapi/orca-portal.yaml by Spring's static-resource handling.
