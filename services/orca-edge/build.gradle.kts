...
openApiGenerate {
	...
	inputSpec = layout.projectDirectory.file("src/main/resources/openapi/orca-edge.yaml").asFile.path
	outputDir = layout.buildDirectory.dir("generated/openapi").get().asFile.path
	apiPackage = "com.lynxis.orca.edge.api.generated"
	modelPackage = "com.lynxis.orca.edge.api.generated.model"
...
val bundleOpenApiSpec = tasks.register<org.openapitools.generator.gradle.plugin.tasks.GenerateTask>("bundleOpenApiSpec") {
	...
	configOptions = mapOf("outputFile" to "static/openapi/orca-edge.yaml")
