...
openApiGenerate {
	...
	inputSpec = layout.projectDirectory.file("src/main/resources/openapi/orca-sync.yaml").asFile.path
	outputDir = layout.buildDirectory.dir("generated/openapi").get().asFile.path
	apiPackage = "com.lynxis.orca.sync.api.generated"
	modelPackage = "com.lynxis.orca.sync.api.generated.model"
...
val bundleOpenApiSpec = tasks.register<org.openapitools.generator.gradle.plugin.tasks.GenerateTask>("bundleOpenApiSpec") {
	...
	configOptions = mapOf("outputFile" to "static/openapi/orca-sync.yaml")
