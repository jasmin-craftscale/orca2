...
export interface CoreConfigurationParameters {
    /**
...
constructor({ accessToken, apiKeys, basePath, credentials, encodeParam, encoder, password, username, withCredentials }: CoreConfigurationParameters = {}) {
        if (apiKeys) {
     ...
     * Uses {@link CoreConfiguration#isJsonMime} to determine the correct content-type.
     ...
     * Uses {@link CoreConfiguration#isJsonMime} to determine the correct accept content-type.
     * If no content type is found return the first found type if the contentTypes is not empty
