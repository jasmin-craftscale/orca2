 ...
 *                   reader and a per-lane election alike
 ...
 */
// BOUNDED, and therefore carries no retention class. There is one row per
// coordination point, updated in place: adding a row means somebody configured
// something, not that traffic arrived.
