...
⚠️ **A plan for an autonomous agent is a different document from a plan for a developer, and this was learned the hard way.** `docs/lane-operations-plan.md` was executed end to end by an outside agent in August; it stopped **five times, and every stop was a defect in the plan rather than in the work.** What that taught, and what every prescriptive plan now needs:
